...
const ROLE_COLORS = {
  "Nikita": "#3B82F6", "Pavel": "#8B5CF6", "Artem": "#06B6D4",
  "Maria": "#EC4899", "Daria": "#F97316", "Eduard": "#F59E0B",
  "Olga": "#10B981", "Sergey": "#EF4444", "Ivan": "#6366F1", "Anna": "#14B8A6",
};
...
export default function TaskBoardPage() {
  ...
  return (
    <div style={{ minHeight: "100svh", background: "#0C0C14", fontFamily: "'Sora','Segoe UI',sans-serif", color: "#E2E8F0", display: "flex", flexDirection: "column" }}>
      ...
      <style>{`@import url('https://fonts.googleapis.com/css2?family=Sora:wght@400;600;700&display=swap'); *{box-sizing:border-box;margin:0;padding:0} ::-webkit-scrollbar{width:3px} ::-webkit-scrollbar-thumb{background:#1E293B;border-radius:2px}`}</style>
    </div>
  );
}